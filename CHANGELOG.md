...
- New `earthaccess-auth` distribution, installable on its own for consumers
  that only need Earthdata Login: `pip install earthaccess-auth`, or with
...
- While downloading, files will have temporary names until download completes. ([@WeatherGod](https://github.com/WeatherGod))
- **BREAKING**: refactored virtualization, now we have a unified virtualize() method that's
  compatible with VirtualiZarr 2.x and is open to most parsers not just dmrpp ([#1271](https://github.com/earthaccess-dev/earthaccess/discussions/1271)) ([@betolink](https://github.com/betolink))
...
- Improved performance of fetching temporary S3 credentials (roughly 4x speedup)
  ...
  ([#1182](https://github.com/earthaccess-dev/earthaccess/issues/1182)) ([@chuckwondo](https://github.com/chuckwondo))
- `open_virtual_datasets` now accepts `load=False` to avoid materializing indexes
  ...
  Fixes ([#1185](http://github.com/earthaccess-dev/earthaccess/issues/1185)) ([@betolink](https://github.com/betolink))

### Added

- Added methods `doi` and `citation` to `DataCollection` class.
  ([#203](https://github.com/earthaccess-dev/earthaccess/issues/203)) ([@Sherwin-14](https://github.com/Sherwin-14), [@chuckwondo](https://github.com/chuckwondo))
- Added property `__geo_interface__` to `DataGranule` class.
  ([#1179](https://github.com/earthaccess-dev/earthaccess/pull/1179)) ([@s-kganz](https://github.com/s-kganz))
...
- **Breaking:** Remove _default automatic login_ behavior.  This removes
  ...
  [#945](https://github.com/earthaccess-dev/earthaccess/issues/945).

### Fixed

- Ignore environment variables `EARTHDATA_USERNAME` and `EARTHDATA_PASSWORD`
  when `EARTHDATA_TOKEN` is set ([#1121](https://github.com/earthaccess-dev/earthaccess/issues/1121)) ([@chuckwondo](https://github.com/chuckwondo))
- Use only specified login strategy to attempt login, when strategy other than
  "all" is specified ([#945](https://github.com/earthaccess-dev/earthaccess/issues/945)) ([@chuckwondo](https://github.com/chuckwondo))
- Fix undesirable pre-commit changes when running on Windows
  ([#1143](https://github.com/earthaccess-dev/earthaccess/issues/1143)) ([@ana-sher](https://github.com/ana-sher))
- No longer erroneously strip authorization header for valid hosts
  ([#1130](https://github.com/earthaccess-dev/earthaccess/issues/1130)) ([@chuckwondo](https://github.com/chuckwondo))
...
- Populated glossary section under USER-REFERENCE. ([#1027](https://github.com/earthaccess-dev/earthaccess/issues/1027)) ([@Sherwin-14](https://github.com/Sherwin-14))
- Change default cache behavior in fsspec from `readahead` to `blockcache`.
  ...
  ([#251](https://github.com/earthaccess-dev/earthaccess/discussions/251))
  ([#771](https://github.com/earthaccess-dev/earthaccess/discussions/771)) ([@betolink](https://github.com/betolink))
- Add `show_progress` argument to `earthaccess.download()` to let the user
  ...
  otherwise false.  ([#612](https://github.com/earthaccess-dev/earthaccess/issues/612))
  ([#1065](https://github.com/earthaccess-dev/earthaccess/pull/1065)) ([@Sherwin-14](https://github.com/Sherwin-14))
- Updated bug and triage label names in bug Issue template.
  ([#998](https://github.com/earthaccess-dev/earthaccess/pull/998)) ([@asteiker](https://github.com/asteiker))
- `download` now raises `DownloadFailure` exception on failure.
  ([#612](https://github.com/earthaccess-dev/earthaccess/issues/612)) ([@Sherwin-14](https://github.com/Sherwin-14))
- `GESDISC` should be `GES_DISC` in docstrings.
  ([#1037](https://github.com/earthaccess-dev/earthaccess/issues/1037)) ([@abarciauskas-bgse](https://github.com/abarciauskas-bgse))
- `open_virtual_mfdataset` now uses `virtualizarr` v2, and `obstore` in place of
  `fsspec`.  Updated Zarr to V3 xref #967.
  ([#1074](https://github.com/earthaccess-dev/earthaccess/issues/1074)) ([@owenlittlejohns](https://github.com/owenlittlejohns))
- Populate search and access user guides.
  ([#1035](https://github.com/earthaccess-dev/earthaccess/pull/1035)) ([@andypbarrett](https://github.com/andypbarrett))

### Added

- Added `tenacity` to retry downloads up to 3 times with exponential backoff time, replaces #1016
  ([#481](https://github.com/earthaccess-dev/earthaccess/issues/481)) ([@betolink](https://github.com/betolink))
- Add notebook demonstrating workflow with TEMPO Level 3 data as a virtual dataset
  ([#924](https://github.com/earthaccess-dev/earthaccess/pull/924)) ([@danielfromearth](https://github.com/danielfromearth))
- `get_s3_filesystem` now accepts an `endpoint` argument for specifying a credentials url.
  ([#602](https://github.com/earthaccess-dev/earthaccess/issues/602)) ([@rwegener2](https://github.com/rwegener2))
- s3 `download` now checks for existing files.
  ([#807](https://github.com/earthaccess-dev/earthaccess/issues/807)) ([@Sherwin-14](https://github.com/Sherwin-14))
- Added triaging guide ([#754](https://github.com/earthaccess-dev/earthaccess/issues/754)) ([@Sherwin-14](https://github.com/Sherwin-14), [@mfisher87](https://github.com/mfisher87))
- `download` now returns Path consistently.
  ([#595])(<https://github.com/earthaccess-dev/earthaccess/issues/595>) ([@Sherwin-14](https://github.com/Sherwin-14))
- Users may now authenticate with an existing Earthdata login token with
  environment variable `EARTHDATA_TOKEN`
  ([#484](https://github.com/earthaccess-dev/earthaccess/issues/484)) ([@kgrimes2](https://github.com/kgrimes2))
- Added top level `status` function to check the statuses of NASA Earthdata services
  ([#161](https://github.com/earthaccess-dev/earthaccess/issues/161)) ([@Sherwin-14](https://github.com/Sherwin-14))
...
- **Breaking:** Removed `has_granules=true` and `include_granule_counts=true`
  ...
  ([#884](https://github.com/earthaccess-dev/earthaccess/issues/884)) ([@Sherwin-14](https://github.com/Sherwin-14))
- Python 3.10 is no longer supported.
  ([#966](https://github.com/earthaccess-dev/earthaccess/pull/966)) ([@weiji14](https://github.com/weiji14))

### Fixed

- Files can be downloaded in the cloud ([#1009](https://github.com/earthaccess-dev/earthaccess/issues/1009)) ([@betolink](https://github.com/betolink))
- Corrected Harmony typo in notebooks/Demo.ipynb ([#995](https://github.com/earthaccess-dev/earthaccess/issues/995)) ([@stelios-c](https://github.com/stelios-c))
- Resolved an error in virtual dataset tutorial notebook ([#1044](https://github.com/earthaccess-dev/earthaccess/issues/1044)) ([@danielfromearth](https://github.com/danielfromearth))
- Issue when `FileDistributionInformation` did not exist for a collection
  ([#971](https://github.com/earthaccess-dev/earthaccess/pull/971)) ([@mike-gangl](https://github.com/mike-gangl))
...
- `search_datasets` now accepts a `has_granules` keyword argument. Use
  ...
  ([#939](https://github.com/earthaccess-dev/earthaccess/issues/939)) ([@juliacollins](https://github.com/juliacollins))
...
- VirtualiZarr: earthaccess can open archival formats (NetCDF, HDF5) as if they were Zarr by leveraging VirtualiZarr
  ...
  See [example notebooks](https://github.com/earthaccess-dev/earthaccess/blob/v0.13.0/docs/tutorials/dmrpp-virtualizarr.ipynb)! ([@ayushnag](https://github.com/ayushnag), [@TomNicholas](https://github.com/TomNicholas))

### Fixed

- `earthaccess.download` will let requests automatically decode compressed content
  ([#887](https://github.com/earthaccess-dev/earthaccess/issues/887)) ([@itcarroll](https://github.com/itcarroll))
...
- Refactored our development guide to clarify development environment setup and how to run tests ([@jhkennedy](https://github.com/jhkennedy))
- Use built-in `assert` statements instead of `unittest` assertions in
  integration tests ([#743](https://github.com/earthaccess-dev/earthaccess/issues/743)) ([@chuckwondo](https://github.com/chuckwondo))

### Added

- Add support for opening data files with virtualizarr and NASA dmrpp with `open_virtual_dataset`
  ([#605](https://github.com/earthaccess-dev/earthaccess/issues/605)) ([@ayushnag](https://github.com/ayushnag))
- Add support for `NETRC` environment variable to override default `.netrc` file
  location ([#480](https://github.com/earthaccess-dev/earthaccess/issues/480)) ([@chuckwondo](https://github.com/chuckwondo))
- Add `nox` session for running integration tests locally
  ([#815](https://github.com/earthaccess-dev/earthaccess/issues/815); [#872](https://github.com/earthaccess-dev/earthaccess/issues/872)) ([@chuckwondo](https://github.com/chuckwondo), [@jhkennedy](https://github.com/jhkennedy))
- Auto-add comment to PR that requires maintainer to review and re-run
  integration tests ([#824](https://github.com/earthaccess-dev/earthaccess/issues/824)) ([@chuckwondo](https://github.com/chuckwondo))
- Add authentication to User Guide documentation. ([#763](https://github.com/earthaccess-dev/earthaccess/pull/763)) ([@andypbarrett](https://github.com/andypbarrett))

### Removed

- The `scripts/integration-test.sh` script has been removed in favor of the `integration-tests` nox session.
  ([#872](https://github.com/earthaccess-dev/earthaccess/issues/872)) ([@jhkennedy](https://github.com/jhkennedy))
- Python 3.9 is no longer supported.
  ([#876](https://github.com/earthaccess-dev/earthaccess/pull/876)) ([@mfisher87](https://github.com/mfisher87))

### Fixed

- `earthaccess.download` will not ignore errors by default
  ([#581](https://github.com/earthaccess-dev/earthaccess/issues/581)) ([@Sherwin-14](https://github.com/Sherwin-14), [@chuckwondo](https://github.com/chuckwondo), [@mfisher87](https://github.com/mfisher87))
- Integration tests no longer clobber existing `.netrc` file
  ([#806](https://github.com/earthaccess-dev/earthaccess/issues/806)) ([@chuckwondo](https://github.com/chuckwondo))
...
- Automatically refresh EDL token and deprecate the `Auth.refresh_tokens` method
  ...
  ([#484](https://github.com/earthaccess-dev/earthaccess/issues/484)) ([@fwfichtner](https://github.com/fwfichtner))
- Deprecate `earthaccess.get_s3fs_session` and `Store.get_s3fs_session`.  Use
  ...
  instead ([#766](https://github.com/earthaccess-dev/earthaccess/issues/766)) ([@Sherwin-14](https://github.com/Sherwin-14), [@chuckwondo](https://github.com/chuckwondo))

### Added

- Add Issue Templates ([#281](https://github.com/earthaccess-dev/earthaccess/issues/281)) ([@Sherwin-14](https://github.com/Sherwin-14))
- Support Service queries
  ([#447](https://github.com/earthaccess-dev/earthaccess/issues/447)) ([@nikki-t](https://github.com/nikki-t), [@chuckwondo](https://github.com/chuckwondo), [@mfisher87](https://github.com/mfisher87), [@betolink](https://github.com/betolink))
- Add example PR links to pull request template
  ([#756](https://github.com/earthaccess-dev/earthaccess/issues/756)) ([@Sherwin-14](https://github.com/Sherwin-14), [@mfisher87](https://github.com/mfisher87))
- Add Contributing Naming Convention document
  ([#532](https://github.com/earthaccess-dev/earthaccess/issues/532)) ([@Sherwin-14](https://github.com/Sherwin-14), [@mfisher87](https://github.com/mfisher87))
...
- Remove `binder/` directory, as we no longer need a special
  ...
  [#733](https://github.com/earthaccess-dev/earthaccess/issues/733) ([@jhkennedy](https://github.com/jhkennedy))

### Fixed

- Remove broken link "Introduction to NASA earthaccess"
  ([#779](https://github.com/earthaccess-dev/earthaccess/issues/779)) ([@Sherwin-14](https://github.com/Sherwin-14))
- Restore automation for tidying notebooks used in documentation
  ([#788](https://github.com/earthaccess-dev/earthaccess/issues/788)) ([@itcarroll](https://github.com/itcarroll))
...
- Perform YAML formatting with `yamlfmt` instead of `prettier`
  ([#555](https://github.com/earthaccess-dev/earthaccess/issues/555)) ([@chuckwondo](https://github.com/chuckwondo), [@mfisher87](https://github.com/mfisher87))
- Replace `print` calls with `logging` calls where appropriate and add T20 Ruff
  rule ([#511](https://github.com/earthaccess-dev/earthaccess/issues/511)) ([@botanical](https://github.com/botanical), [@chuckwondo](https://github.com/chuckwondo), [@mfisher87](https://github.com/mfisher87))
- Update `CHANGELOG.md` to follow Common Changelog conventions
  ([#584](https://github.com/earthaccess-dev/earthaccess/pull/584)) ([@danielfromearth](https://github.com/danielfromearth), [@chuckwondo](https://github.com/chuckwondo), [@jhkennedy](https://github.com/jhkennedy), [@mfisher87](https://github.com/mfisher87))

### Added

- Enable queries to Earthdata User Acceptance Testing (UAT) system for
  authenticated accounts
  ([#421](https://github.com/earthaccess-dev/earthaccess/issues/421)) ([@danielfromearth](https://github.com/danielfromearth), [@mfisher87](https://github.com/mfisher87), [@jhkennedy](https://github.com/jhkennedy), [@chuckwondo](https://github.com/chuckwondo), [@betolink](https://github.com/betolink))
- Add support for Python 3.12
  ([#457](https://github.com/earthaccess-dev/earthaccess/issues/457)) ([@chuckwondo](https://github.com/chuckwondo), [@mfisher87](https://github.com/mfisher87))
- Added documentation for the backwards compatibility
  ([#471](https://github.com/earthaccess-dev/earthaccess/issues/471)) ([@Sherwin-14](https://github.com/Sherwin-14), [@mfisher87](https://github.com/mfisher87))

### Removed

- **Breaking:** Remove support for Python 3.8
  ([#457](https://github.com/earthaccess-dev/earthaccess/issues/457)) ([@mfisher87](https://github.com/mfisher87), [@chuckwondo](https://github.com/chuckwondo))
...
- Use
  ...
  result sets ([#483](https://github.com/earthaccess-dev/earthaccess/issues/483)) ([@doug-newman-nasa](https://github.com/doug-newman-nasa), [@chuckwondo](https://github.com/chuckwondo), [@mfisher87](https://github.com/mfisher87), [@betolink](https://github.com/betolink))
- Correct and enhance static type hints for functions and methods that make CMR
  queries or handle CMR query results
  ([#508](https://github.com/earthaccess-dev/earthaccess/issues/508)) ([@mfisher87](https://github.com/mfisher87), [@jhkennedy](https://github.com/jhkennedy), [@chuckwondo](https://github.com/chuckwondo), [@betolink](https://github.com/betolink))
- Create destination path prior to direct S3 downloads, if it doesn't already
  exist ([#562](https://github.com/earthaccess-dev/earthaccess/issues/562)) ([@itcarroll](https://github.com/itcarroll), [@mfisher87](https://github.com/mfisher87), [@chuckwondo](https://github.com/chuckwondo))
...
- Improve search by adding instrument and project to collection queries
  ([#427](https://github.com/earthaccess-dev/earthaccess/issues/427)) ([@betolink](https://github.com/betolink), [@mfisher87](https://github.com/mfisher87), [@jhkennedy](https://github.com/jhkennedy))
- Add user-agent in the request to track usage
  ([#436](https://github.com/earthaccess-dev/earthaccess/issues/436)) ([@asteiker](https://github.com/asteiker), [@mikedorfman](https://github.com/mikedorfman), [@betolink](https://github.com/betolink))

### Fixed

- Implement more trusted domains in the SessionWithRedirection
  ([#439](https://github.com/earthaccess-dev/earthaccess/issues/439)) ([@cmspeed](https://github.com/cmspeed), [@mfisher87](https://github.com/mfisher87), [@betolink](https://github.com/betolink), [@jhkennedy](https://github.com/jhkennedy))
...
- Update poetry lockfile ([#403](https://github.com/earthaccess-dev/earthaccess/pull/403)) ([@jrbourbeau](https://github.com/jrbourbeau))
- Use YAML formatting (prettier) ([#398](https://github.com/earthaccess-dev/earthaccess/pull/398)) ([@jrbourbeau](https://github.com/jrbourbeau))

### Added

- Add CI tests with minimum supported versions
  ([#402](https://github.com/earthaccess-dev/earthaccess/pull/402)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87), [@jhkennedy](https://github.com/jhkennedy))
- Add `python-dateutil` as a direct dependency ([#397](https://github.com/earthaccess-dev/earthaccess/pull/397)) ([@jrbourbeau](https://github.com/jrbourbeau))

### Removed

- Remove binder PR comments ([#400](https://github.com/earthaccess-dev/earthaccess/pull/400)) ([@jrbourbeau](https://github.com/jrbourbeau))

### Fixed

- Enable AWS check with IMDSv2
  ([#391](https://github.com/earthaccess-dev/earthaccess/pull/391)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87), [@itcarroll](https://github.com/itcarroll))
- Add region to running in AWS check
  ([#395](https://github.com/earthaccess-dev/earthaccess/pull/395)) ([@jrbourbeau](https://github.com/jrbourbeau), [@betolink](https://github.com/betolink))
...
- Handle S3 credential expiration more gracefully
  ([#354](https://github.com/earthaccess-dev/earthaccess/pull/354)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87))
- Use dependabot to update GitHub Actions
  ([#373](https://github.com/earthaccess-dev/earthaccess/pull/373)) ([@jhkennedy](https://github.com/jhkennedy))
- Consolidate dependabot updates
  ([#380](https://github.com/earthaccess-dev/earthaccess/pull/380)) ([@mfisher87](https://github.com/mfisher87))
- Switch to `ruff` for formatting
  ([#372](https://github.com/earthaccess-dev/earthaccess/pull/372)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87))
...
- Raise errors instead of `print`ing them in more cases
  ([#351](https://github.com/earthaccess-dev/earthaccess/pull/351)) ([@jrbourbeau](https://github.com/jrbourbeau))
- `daac` and `provider` parameters are now normalized to uppercase, since
  lowercase characters are never valid
  ([#355](https://github.com/earthaccess-dev/earthaccess/pull/355)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87))
- Allow single file URL inputs for `earthaccess.download`
  ([#347](https://github.com/earthaccess-dev/earthaccess/pull/347)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87))
...
- `earthaccess.download` now accepts a single granule as input in addition to a
  list of granules ([#317](https://github.com/earthaccess-dev/earthaccess/pull/317)) ([@jrbourbeau](https://github.com/jrbourbeau))
- `earthaccess.download` now returns fully qualified local file paths
  ([#317](https://github.com/earthaccess-dev/earthaccess/pull/317)) ([@jrbourbeau](https://github.com/jrbourbeau))
...
- Earthaccess will now automatically search for Earthdata authentication.
  ...
  ([#300](https://github.com/earthaccess-dev/earthaccess/pull/300)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87))
- Add `earthaccess.auth_environ()` utility for getting Earthdata authentication
  environment variables ([#316](https://github.com/earthaccess-dev/earthaccess/pull/316)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mfisher87](https://github.com/mfisher87))

### Fixed

- Fix spelling mistake in `access` variable assignment (`direc` -> `direct`) in
  `earthaccess.store._get_granules`
  ([#308](https://github.com/earthaccess-dev/earthaccess/pull/308)) ([@trey-stafford](https://github.com/trey-stafford))
...
- `earthaccess.get_s3fs_session()` can use the results to find the right set of
  S3 credentials ([#296](https://github.com/earthaccess-dev/earthaccess/pull/296)) ([@betolink](https://github.com/betolink))

### Fixed

- `earthaccess.search_datasets()` and `earthaccess.search_data()` can find
  restricted datasets ([#296](https://github.com/earthaccess-dev/earthaccess/pull/296)) ([@betolink](https://github.com/betolink))
...
- Add download from onprem how-to
  ([#265](https://github.com/earthaccess-dev/earthaccess/pull/265)) ([@andypbarrett](https://github.com/andypbarrett))

### Changed

- For CI, integration tests are now only run when we push to main (after a
  merge) ([#267](https://github.com/earthaccess-dev/earthaccess/pull/267)) ([@betolink](https://github.com/betolink))
- For CI, unit tests are run for any branch and opened PR
  ([#267](https://github.com/earthaccess-dev/earthaccess/pull/267)) ([@betolink](https://github.com/betolink))
- Update example in `search_datasets`
  ([#247](https://github.com/earthaccess-dev/earthaccess/pull/247)) ([@jrbourbeau](https://github.com/jrbourbeau))
- Improve remote cluster performance
  ([#259](https://github.com/earthaccess-dev/earthaccess/pull/259)) ([@jrbourbeau](https://github.com/jrbourbeau), [@mrocklin](https://github.com/mrocklin), [@mfisher87](https://github.com/mfisher87))
- Return useful error message for failed download
  ([#263](https://github.com/earthaccess-dev/earthaccess/pull/263)) ([@andypbarrett](https://github.com/andypbarrett))
...
- Remove Benedict (core dependency) as the default dict for JSON coming from CMR
  ([#229](https://github.com/earthaccess-dev/earthaccess/pull/229),
  [#230](https://github.com/earthaccess-dev/earthaccess/issues/230)) ([@psarka](https://github.com/psarka))
...
- For CI, documentation for readthedocs fixed by including poetry as the default
  tool ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214)) ([@betolink](https://github.com/betolink))
- For CI, injected new secrets to test Auth using the icepyx convention
  (EARTHDATA_USERNAME) ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214)) ([@JessicaS11](https://github.com/JessicaS11), [@betolink](https://github.com/betolink))

### Added

- Add ability to get the user's profile with auth.user_profile which includes
  the user email ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214)) ([@betolink](https://github.com/betolink))
...
- Remove magic from dependencies (not available in windows and not used but just
  in tests) ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214)) ([@betolink](https://github.com/betolink))

### Fixed

- `get_s3_credentials()` only worked when a netrc file was present, bug reported
  by [@scottyhq](https://github.com/scottyhq) and [@JessicaS11](https://github.com/JessicaS11)
  ([#214](https://github.com/earthaccess-dev/earthaccess/pull/214)) ([@betolink](https://github.com/betolink), [@JessicaS11](https://github.com/JessicaS11), [@scottyhq](https://github.com/scottyhq))
...
- For CI, documentation is now only built for the main, dev and documentation
  branches ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202)) ([@betolink](https://github.com/betolink))
- For CI, notebooks are executed every time the documentation gets published!
  ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202)) ([@betolink](https://github.com/betolink), [@asteiker](https://github.com/asteiker))

### Added

- Add ability to use the top level API to get S3 credentials, authenticated
  fsspec and requests sessions!
  ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202)) ([@betolink](https://github.com/betolink))
...
- Fix a bug where the Auth class is invoked without the proper parameters
  ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202)) ([@JessicaS11](https://github.com/JessicaS11))
- Raise and exception if a user specifies the netrc strategy and there is no
  netrc ([#202](https://github.com/earthaccess-dev/earthaccess/pull/202)) ([@betolink](https://github.com/betolink))
...
- Fix open() for direct access ([#186](https://github.com/earthaccess-dev/earthaccess/pull/186)) ([@betolink](https://github.com/betolink))
...
- For CI, only run the publish workflow after a release on GitHub ([#183](https://github.com/earthaccess-dev/earthaccess/pull/183)) ([@betolink](https://github.com/betolink))

### Added

- Add feature to search collections by DOI
  ([#183](https://github.com/earthaccess-dev/earthaccess/pull/183)) ([@betolink](https://github.com/betolink))
...
- Improve documentation by reimplementing python_cmr methods for docstring
  compatibility ([#131](https://github.com/earthaccess-dev/earthaccess/pull/131)) ([@betolink](https://github.com/betolink))
- Use `CMR-Search-After`
  ([#145](https://github.com/earthaccess-dev/earthaccess/issues/145)) ([@betolink](https://github.com/betolink))
...
- Add store, auth to docs and update mkdocs config ([#119](https://github.com/earthaccess-dev/earthaccess/pull/119)) ([@betolink](https://github.com/betolink))
- For `auth`, add the ability to persist credentials into a `.netrc` file ([#119](https://github.com/earthaccess-dev/earthaccess/pull/119)) ([@betolink](https://github.com/betolink))
- For `store`, use fsspec s3fs for in cloud access and https sessions for out of
  region access ([#43](https://github.com/earthaccess-dev/earthaccess/issues/43)) ([@betolink](https://github.com/betolink))
...
- Update python-cmr to NASA fork ([#75](https://github.com/earthaccess-dev/earthaccess/pull/75)) ([@jhkennedy](https://github.com/jhkennedy))
- Drop unused `pydantic` dependency
  ([`5761548`](https://github.com/earthaccess-dev/earthaccess/pull/75/commits/5761548fcd8ba8733ce4f5ff9b8ce7967c3a8398)) ([@jhkennedy](https://github.com/jhkennedy))
- Auth can refresh CMR tokens ([#82](https://github.com/earthaccess-dev/earthaccess/pull/82)) ([@betolink](https://github.com/betolink))
- Verify git tag and poetry version are the same before publishing to PyPI

### Added

- Add documentation for readthedocs and GitHub ([#82](https://github.com/earthaccess-dev/earthaccess/pull/82)) ([@betolink](https://github.com/betolink))

### Removed

- **Breaking**: Drop python 3.7 support ([#82](https://github.com/earthaccess-dev/earthaccess/pull/82)) ([@betolink](https://github.com/betolink))
...
- Rename Accessor to Store
  ([`4bd618d`](https://github.com/earthaccess-dev/earthaccess/pull/66/commits/4bd618d4d48c3cd256a077fb8329f40df2d5b7ff)) ([@betolink](https://github.com/betolink))
- Relax dependency requirements
  ([`c9a5ed6`](https://github.com/earthaccess-dev/earthaccess/pull/66/commits/c9a5ed6b917435e7c4ece58485939065fa71cc8f)) ([@betolink](https://github.com/betolink))
